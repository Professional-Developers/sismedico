...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-05-2016 a las 03:06:22
...
(1, 1, 1, 'Luis23', 'Gonzalez', 'Torres', '2016-05-15', 'Cajamarca 108', 'no hay', '1', 'Prueba', '0', 'nueva', '46088871', 'Viru', 'trujillo', 1, 'estudiante', 5, '2016-05-15', NULL, 1, NULL, 'correo', '2016050001'),
(2, 1, 1, 'andy', 'Gonzalez2', 'Torres2', '2016-05-15', 'Cajamarca 108', 'no hay', '1', 'Prueba', '0', 'nueva', '46088871', 'Viru', 'Lima', 1, 'estudiante', 5, '2016-05-15', NULL, 1, NULL, 'correo', '2016050002'),
(3, 4, 1, 'LUIS', 'FONSI', 'ALVAREZ', '2016-05-09', 'LORETO 132', 'NO HAYYYY', '1', 'Prueba', '0', 'nueva', '44141215', 'TRUJILLO', 'CASMA', 2, 'INGENIERO', 5, '2016-05-25', NULL, 1, NULL, 'correo', '2016050003'),
(4, 2, 4, 'LUIS', 'RODRIGUEZ', 'ARMANZA', '2016-05-25', 'A123', 'CASA', '1', 'Prueba', '0', 'nueva', '45871345', 'ANCASH', 'ESTE', 1, 'INGENIERO', 5, '2016-05-25', NULL, 1, NULL, 'correo', '2016050004'),
(5, 2, 4, 'LUIS34', 'RODRIGUEZ233', 'ARMANZA55', '2016-05-25', 'A123', 'CASA', '1', 'Prueba', '0', 'nueva', '45871345', 'ANCASH', 'ESTE', 1, 'INGENIERO', 5, '2016-05-25', NULL, 1, NULL, 'correo', '2016050005'),
(6, 3, 7, 'TULIPANES', 'GONZALEZ', 'TORRES', '2016-05-11', 'CAXA', 'OBS', '1', 'Prueba', '0', 'nueva', '45112233', 'VIRUS', 'LA LIBERTAD', 1, 'ABOGADO', 5, '2016-05-25', NULL, 1, NULL, 'correo', '2016050006'),
(7, 1, 1, 'EDX2', 'CASAS2', 'CASAS2', '2016-05-25', '', '', '1', 'Prueba', '0', 'nueva', '', '', '', 1, '', 5, '2016-05-25', NULL, 1, NULL, 'correo', '2016050007'),
(8, 1, 1, 'SILVIA', 'CASITA', 'OIGA', '2016-05-25', '', '', '1', 'Prueba', '0', 'Hydrangeas.jpg', '', '', '', 1, '', 5, '2016-05-25', NULL, 1, NULL, 'correo', '2016050008');
...
(1, 6, 'algo', 0, 'Correo', 'yo', '1'),
(2, 6, 'algo', 0, 'Correo', 'yo', '1'),
(3, 6, 'algo2', 0, 'Correo', 'yo2', '1'),
(4, 6, 'cricri', 0, 'LinkedIn', '12', '0');
...
--
ALTER TABLE `paciente`
MODIFY `nCodigoPaciente` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `redsocialpaciente`
MODIFY `nCodigoRedSocial` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `telefonopaciente`
MODIFY `nCodigoTelefono` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
--
