...
function paginaDataTable(dataTable) {
    // definiciones por defecto  
    //dataTable["ordenaPor"] = (dataTable["ordenaPor"] != undefined) ? dataTable["ordenaPor"] : [[0,"desc"]]; 
    //    dataTable["ordenaPor"] = (dataTable["ordenaPor"] != undefined) ? dataTable["ordenaPor"] : [[0,"asc"]]; 
    /*dataTable["desactOrdenaEn"] = (dataTable["desactOrdenaEn"] != undefined) ? dataTable["desactOrdenaEn"] : [];*/
    dataTable["filsXpag"] = ( dataTable["filsXpag"] != undefined) ?  dataTable["filsXpag"] : 10;
...
function paginaDataTableOpcCortas(dataTable) {
    // definiciones por defecto  
    //dataTable["ordenaPor"] = (dataTable["ordenaPor"] != undefined) ? dataTable["ordenaPor"] : [[0,"desc"]]; 
    //    dataTable["ordenaPor"] = (dataTable["ordenaPor"] != undefined) ? dataTable["ordenaPor"] : [[0,"asc"]]; 
    /*dataTable["desactOrdenaEn"] = (dataTable["desactOrdenaEn"] != undefined) ? dataTable["desactOrdenaEn"] : [];*/
...
function msgLoading(obj,msg){
    if(msg == undefined){
        ...
        $(obj).html("<div id='msg_saving' style='display:inline;'><img src='"+URL_MAIN+"images/loaders/3d/019.gif'/></div>");
    }else{
//        $(obj).html("<div id='msg_loading' style='color:#2D91D4;font-size:0.75em'><div class='gif_loading'></div>&nbsp;"+" "+msg+"</div>");
        $(obj).html("<div id='msg_saving' style='display:inline;'><img src='"+URL_MAIN+"images/loaders/3d/019.gif'/>&nbsp;"+" "+msg+"</div>");
    }
}
...
function msgLoadSave(obj,btn){ //preload al costado del boton
    ...
    //$(obj).html("<div id='msg_saving' style='display:inline;'><img src='images/loader.gif'/></div>");
    $(obj).html("<div id='msg_saving' style='display:inline;'><img src='images/loaders/3d/019.gif'/></div>");
}
function msgLoadSaveMsg(obj,btn,msg){ //preload al costado del boton
    $(btn).attr("disabled", "true");
    //$(obj).html("<div id='msg_saving' style='display:inline;'><img src='../images/barraProgreso.gif'/>"+msg+"</div>");
    $(obj).html("<div id='msg_saving' style='display:inline;'><img src='images/loaders/3d/019.gif'/>"+msg+"</div>");
}
...
/*
@Authors : jvinceso
@Descripcion : Arma formulario de subir archivos
...
/* CREADOR DE DATA-TABLES - CONSTRUYE UNA GRILLA PAGINADA */
function paginaDataTableAsc(obj){
    //$("#"+dataTable).dataTable();
    obj['JQueryUI'] = ( obj['JQueryUI'] != undefined ) ? false : obj['JQueryUI'] ;
    // obj['filtro']   = ( obj['filtro'] == "no" ) ? true : false;
    // obj['info']     = ( obj['info'] == "no" ) ? true : false;
    $('#'+obj['tabla']+"").dataTable( {
        // "aLengthMenu": obj['CBO'][[15,30, 50]],
        "aaSorting" : [[0,"asc"]],
        "sPaginationType": "full_numbers",
        "iDisplayLength" : obj['filas'],
        "bJQueryUI"      : obj['JQueryUI'],
        "oLanguage"             :     {
            "sEmptyTable"       :     "Tabla sin data disponible",
            "sInfo"             :     "Mostrando desde _START_ hasta _END_ de _TOTAL_ registros",
            "sInfoEmpty"        :     "Mostrando desde 0 hasta 0 de 0 registros",
...
function evtScrollTop(){
    $("html, body").animate({
        scrollTop:0
    },600);
    return false;
}
function evtScrollBot(){
    $("html, body").animate({
