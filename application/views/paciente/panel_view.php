                        ...
                        <div class="col-lg-12">
                            <div class="tabs-container">
                                <ul class="nav nav-tabs">
                                    ...
                                    <!--<li class=""><a data-toggle="tab" href="#tab-qry-pacientes" id="listaPacientes"> Relación de Pacientes</a></li>-->
                                    <!--<li class=""><a data-toggle="tab" href="#tab-2">Teléfonos</a></li>-->
                                    <!--<li class=""><a data-toggle="tab" href="#tab-3">Correo y Redes</a></li>-->
                                    <!--<li class=""><a data-toggle="tab" href="#tab-4">Cuentas Pendientes</a></li>-->
                                     <input type="hidden" id="hdn_codigopaciente" value="0" />
                                    <li class="active mistabs" id="li1-qrypacientes"><a data-toggle="tab" href="#tab-1-qry-pacientes" id="listaPacientes"> Registrar Paciente</a></li>
                                ...
                                <div class="tab-content">
                                    <div id="tab-qry-pacientes" class="tab-pane">
                                        Relacion xd
                                    </div>
                                        ...
                                        <div id="bloqueo" class="panel-body">
                                            <form method="get" class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" id="txtNombrePaciente" class="form-control" value="">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" id="txtApellidoPaterno" class="form-control" value="" maxlength="20">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" id="txtApellidoMaterno" class="form-control" value=""  maxlength="20">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" id="txtDNI" class="form-control" value="" maxlength="8">
                                                    </div>
                                                    <label class="col-sm-2 control-label">Ocupación</label>
                                                    <div class="col-sm-3">
                                                        <input type="text" id="txtOcupacion" class="form-control" value=""  maxlength="20">
                                                    </div>
                                                    <di class="col-sm-2"></br></di>
                                                </div>
                                                <div class="form-group" id="data_1">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" name="txtCentroTrabajo" id="txtCentroTrabajo" class="form-control" value=""  maxlength="20">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" id="txtProcedencia" class="form-control" value=""  maxlength="20">
                                                    </div>
                                                    <label class="col-sm-2 control-label">Observaciones</label>
                                                    <div class="col-sm-3">
                                                        <input type="text" id="txtObservaciones" class="form-control" value=""  maxlength="20">
                                                    </div>
                                                    <di class="col-sm-2"></br></di>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" id="txtDireccion" class="form-control" value=""  maxlength="50">
                                                    </div>
...
<!--<script type="text/javascript" src="<?php echo URL_JS; ?>paciente/jsPacientePanel_revisar.js"></script>-->
...
<script type="text/javascript" src="<?php echo URL_JS; ?>paciente/nuevopaciente/jsPacienteNuevoPacientes.js"></script>
