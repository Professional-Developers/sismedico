...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-05-2016 a las 08:25:42
...
--
ALTER TABLE `redsocialpaciente`
MODIFY `nCodigoRedSocial` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `telefonopaciente`
MODIFY `nCodigoTelefono` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
